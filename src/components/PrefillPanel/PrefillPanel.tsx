...
interface Props {
  ...
  onUpdateMapping: (nodeId: string, fieldKey: string, value: string | null) => void
}

export default function PrefillPanel({ node, allNodes, allForms, onUpdateMapping }: Props) {
      ...
      {prefillEnabled && (
        <List>
          {fieldKeys.map((fieldKey) => {
              ...
              return (
                <ListItem key={fieldKey}>
                  ...
                  <ListItemSecondaryAction>
                    ...
                    <IconButton edge="end" onClick={() => onUpdateMapping(node.id, fieldKey, null)}>
                      <CloseIcon />
                    </IconButton>
                  </ListItemSecondaryAction>
                </ListItem>
            ...
            return (
              <ListItemButton key={fieldKey} onClick={() => openModal(fieldKey)}>
                <ListItemText primary={fieldKey} />
              </ListItemButton>
            )
          })}
